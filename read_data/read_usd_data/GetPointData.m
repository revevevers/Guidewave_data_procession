...
% signalname is the name of the signal, e.g. 'Velo city' or 'Displacement'
...
%
    try
        ...
        % 处理错误并显示错误信息
        error('Failed to create ActiveX server. ProgID ''PolyFile.PolyFile'' is invalid or not registered.');
    end
try
    file.Open(filename);
